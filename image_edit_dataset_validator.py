...
def validate_image_pair(input_path, output_path, face_app, 
    ...
    if face_similarity_threshold is not None and face_similarity_threshold > 0:
...
def main():
    ...
    parser.add_argument("--face_similarity_threshold", type=float, default=None, 
                       help="얼굴 유사도 임계값 (이하여야 성공, None이면 검사 안함)")
